> [!NOTE]
请注意 本readme为stack形式更新 请维护者在第一行添加内容，请不要覆盖前面的note。
本仓库目前在至少一个生产环境中稳定运行了1年之久，作者从未收到任何经济支持。
请谅解作者精力有限，issues已经无力回复，所以有需求请手动fork test pr，本仓库若无致命缺陷将不继续维护。
---

> [!TIP]
为了避免泄露用户的信息，gitignore了db.sqlite3文件
setting中的salt和与域名白名单未在任何生产环境中使用，请逆向者跳过该尝试
---
